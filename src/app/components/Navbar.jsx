  ...
  return (
    ...
    <nav className='fixed top=0 left-0 right-0 z-10 bg-[#574F4A] bg-opacity-95'>
        <div className='container flex flex-wrap items-center justify-between mx-auto px-12 p-4'>
            <Link href={"/"} className='text-[#FDF9F7] font-bold'>melaniequek</Link>
            ...
            <div className='menu hidden md:block md:w-auto' id="navbar">
                <ul className='flex p-4 md:p-0 flex-row items-center'>
                    <li><Link href={"/#works"} className='text-[#FDF9F7] hover:text-[#c8bec881] font-bold block py-2 pl-3 pr-4'>Works</Link></li>
                    <li><Link href={"/about"} className='text-[#FDF9F7] hover:text-[#c8bec881] font-bold block py-2 pl-3 pr-4'>About Me</Link></li>
                    <li><Link href={"/Melanie's Resume.pdf"} target="_blank" className='text-[#FDF9F7] hover:text-[#c8bec881] font-bold block py-2 pl-3 pr-4 
