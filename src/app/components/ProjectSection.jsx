...
const projectsData =[
    {
        ...
        description: "A virtual queuing system to reduce physical queue times for staff during lunch hours.",
...

    {
        ...
        description: "Connecting apartment hunting with district research, improving accessibility and security for prospective tenants.",
...

    {
        ...
        description: "Decide where and what to eat collaboratively, with trusted recommendations from your social circles.",
...

    {
        ...
        description: "A community spirit-building application to help identify noise disturbance sources in the Sembawang community.",
...
const ProjectSection = () => {
  ...
  return (
    <div>
      <h2 className='text-center text-3xl font-bold text-[#574F4A] mt-12'> My Works</h2>
