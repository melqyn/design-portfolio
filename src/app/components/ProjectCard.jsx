...
const ProjectCard = ({imgUrl, title, projectinfo, description, url}) => {
  return (
    ...
    <div className='h-full shadow-lg rounded-xl overflow-hidden hover:shadow-xl 
        hover:border-solid hover:border-2 hover:border-[#fff] hover:rounded-xl'>
      <div className="h-52 m:h-72 rounded-t-xl" style={{background:`url(${imgUrl})`, backgroundSize:"cover", backgroundPosition:"center"}}></div>
