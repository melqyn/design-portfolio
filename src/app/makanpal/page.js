    ...
    <main className="flex min-h-screen flex-col bg-[#FFFBFA]">
        ...
        <div className="container grid grid-cols-1 md:grid-cols-12 mt-36 mx-auto py-4 pl-12">
          <div className="col-span-12">
            <Image
              ...
              height={500}
              alt="makanpal image"
              className="hidden  md:block md:absolute md:top-0 md:right-0 md:-mr-12"
            ></Image>
          ...
          <div className="col-span-5">
            <p className="text-[#574F4A] font-light pb-8 md:pb-16">
              A virtual queuing system to reduce physical queue times for staff
              during lunch hours.
            </p>
          </div>
        </div>
      ...
      <div className="container mt-24 mx-auto px-12">
        ...
        <h2 className="text-xl font-semibold text-[#363636] pb-2">
          Concept of Virtual Queuing
        </h2>
        <p className="text-[#636363] leading-relaxed pb-8">
          To help you better understand this case study about a virtual queuing
          system, I will first explain the project concept of a virtual queue,
          and the contextual challenges it entails.
        </p>
        ...
        <Image src={userGroupsBig} width={800} height={200} alt="user groups" />
        ...
        <Image src={process} width={800} height={200} alt="process" />

        <CSTitleParagraph
          largetitle={`1. Review Feedback from Handover`}
        ...
        <div className="pb-8">
          <table class="text-left text-sm font-light text-surface dark:text-white">
            <thead class="border-b border-neutral-200 bg-[#FBC34E] font-medium text-white dark:border-white/10">
              ...
              <tc class=" px-6 py-4">
                <th class=" px-6 py-4">Problems</th>
                <tr>
                  <th class=" px-6 py-4">Impact on Staff</th>
                  <th class=" px-6 py-4">Impact on Merchant Ops</th>
                </tr>
              </tc>
            </thead>
              ...
              <tc>
                <ul>
                  <li class="whitespace-nowrap  px-6 py-4">
                    gave estimated time period that did not reflect real-time
                    status
                  </li>
                  <li class="whitespace-nowrap  px-6 py-4">
                    no current queue number of stall for estimation (just like
                    in physical queue)
                  </li>
                  <li class="whitespace-nowrap  px-6 py-4">
                    no option to “leave” virtual queue
                  </li>
                </ul>
              </tc>
              <tc>
        ...
        <div className="border-[#76655B] border-l-4 px-4 mb-4 leading-relaxed">
          ...
          <p className="text-[#76655B]">
            HMW help users feel confident that their queue ticket is valid and
            moving?
          </p>
          <p className="text-[#76655B]">
        ...
        <Image src={userflow} width={400} height={300} alt="User Flow" />

        <CSTitleParagraph
          largetitle={`3. Agile Development - Designing in Agile Scrum`}
        ...
        <CSTitleParagraph
          largetitle={
            "4. Staff Mobile App Testing: Internal Department Review + Guerrilla User Testing"
          }
          paragraph={
            "We conducted Guerrilla User Testing in the canteen, interviewing a total of 30 staff. Some key sentiments are as follows:"
          }
        />
        ...
        <div className="grid grid-cols-12 gap-4 pb-16">
          <div className="col-span-4 p-4 rounded-xl bg-[#FBC34E] bg-opacity-20">
            <p>
              “I clicked too fast and did not see the queue status from the
              previous [stall selection] page”
            </p>
          </div>
          <div className="col-span-4 p-4 rounded-xl bg-[#FBC34E] bg-opacity-20">
            <p>
              “I could not tell the difference between the two screens [when
              queue time decreased to below 5 minutes]”
            </p>
          </div>
        ...
        <CSTitleParagraph
          largetitle={"Using Colours to Assure Users"}
        ...
        <div className="grid grid-cols-12">
          <div className="col-span-6">
            <Image
              ...
              width={400}
              height={300}
              alt="Colour indicators"
            />
          </div>
          <div className="col-span-6">
            <p className="text-[#76655B] pb-2">
              Introduced colours to help customers notice changes in wait time.
            </p>
            <p className="text-[#76655B]">
              This change was validated in our subsequent internal department
              review.{" "}
            </p>
          </div>
        </div>
        ...
        <CSTitleParagraph
          largetitle={
            "Improving User Freedom + Match between System and Real World"
          }
        ...
        <CSTitleParagraph
          title={"Challenge #2"}
          largetitle={
            "Integrating technology into merchants’ current physical workflow"
          }
          paragraph={
            "One main user group of our application is our canteen stall vendors (referred to as merchants throughout this case study). These merchants are mostly in their late 50s to 60s, and are non-tech savvy - as self-reported. In an earlier one-day test trial (before I joined the team), they have already shown resistance towards the adoption of technology in their workflow. With the HRD pushing for the revamp and renewal of the staff canteen into a ‘digital canteen’, our team is faced with the challenge to balance the business directions of the company with the needs and comfortability of our merchants."
          }
        />
        <div className="border-[#76655B] border-l-4 px-4 leading-relaxed mb-16">
          <p className="text-[#76655B] font-semibold">
            How can we integrate technology into non-tech savvy merchants’
            current workflow to optimise service efficiency?
          </p>
        </div>

        <CSTitleParagraph
          title={"Key Improvementsfor Challenge #2"}
          largetitle={"Design Principles for Merchant App"}
        />
        <div>
          <p className="text-[#76655B] pb-2">
            There were 2 main design principles I used to design the Merchant
            app:
          </p>
          <p className="text-[#76655B] pb-2">
            1. Elderly-friendly; 2. Prioritise main function of managing virtual
            queue
          </p>
          <div className="grid grid-cols-3">
            ...
            <div className="col-span-2">
              <p className="text-[#76655B] pb-2">
                Catering to our elderly Mandarin-speaking merchants, design
                decisions included:
              </p>
              <ul>
                <li>choosing large, readable fonts</li>
                <li>
                  a large primary button for main function (explained below)
                </li>
              ...
              <p className="text-[#76655B] pb-2">
                ...
                workflow. Intentional design decisions were made to prioritise
                the main function of managing a virtual queue - to call the next
                group of customers. Hence, the main working screen was designed
                with great emphasis on a large button to call the next group of
          ...
          <p className="text-[#76655B] pb-2">
            After a quick user testing, we noticed that our merchants often feel
            hurried to call the next batch, clicking on the button multiple
            times. Thus, we also programmed a button time-out (to prevent double
            clicking when rushing orders).
          </p>
        </div>
      </div>
